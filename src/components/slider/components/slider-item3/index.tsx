...
import neon from "../../../../assets/neon3.png";
import menu from "../../../../assets/menu3.png";

const SliderItemTree= () => {
  return (
    <div className="relative bg-cover bg-no-repeat bg-[url('./assets/slider/img3.png')] h-full w-full bg-slate-50">
